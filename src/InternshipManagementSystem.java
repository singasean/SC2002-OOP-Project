...
public class InternshipManagementSystem {
    ...
    public void loadInitialData(String studentCSV, String companyCSV, String staffCSV) {
        ...
        for (CompanyRepresentative r : reps) {
            ...
            authService.registerEmail(r.getEmail(), r.getUserID());
        }
    ...
    public void run() {
        ...
        while (running) {
            ...
            outputService.displayMessage("2. Company Representative Login (use Email)");
    ...
    private boolean isLogoutChoice(String choice, User user) {
        ...
        if (user instanceof CareerCenterStaff) return "9".equals(choice);
        return false;
    }
